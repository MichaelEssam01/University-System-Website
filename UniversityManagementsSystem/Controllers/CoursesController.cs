...
namespace UniversityManagementsSystem.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseID,CourseName,CourseCode,DepartmentID,Credits")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("CourseID,CourseName,CourseCode,DepartmentID,Credits")] Course course)
        {
